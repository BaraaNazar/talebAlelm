...
function LoadingPage() {
  return (
    <div className='flex flex-col justify-center items-center text-center h-screen space-y-10'>
        <img className='h-fit w-1/2 lg:w-52' src={alkitabLogo} alt="alkitab logo" />
        <h1 className='text-2xl font-bold lg:text-4xl'>قال النبي صلى الله عليه وسلم
...
رواه البخاري</h1>
        <div >
  <button type="button" className="flex items-center rounded-lg px-4 py-2 text-white lg:hidden" disabled>
