    ...
    <div>
      ...
      <div className='p-5 space-y-5'>
        ...
        <div className=' flex flex-col justify-center items-center space-y-2 text-lg'>
          ...
          <button type="button" className="text-white bg-yellow-500   hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-full px-5 py-2.5 text-center justify-center items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2 w-72">
              ابدا الان
          </button>
