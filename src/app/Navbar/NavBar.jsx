      ...
      <div>
        ...
        >
          <div id='tabs' className='flex justify-between'>
            <Link
              href='/home'
              className='w-full focus:text-yellow-500 hover:text-yellow-500 justify-center inline-block text-center pt-2 pb-1'
            >
              <svg
                width='25'
                height='25'
              ...
              <span className='tab tab-home block text-xs'>الرئيسية</span>
            </Link>
            <Link
              href='/Sections'
              className='w-full focus:text-yellow-500 hover:text-yellow-500 justify-center inline-block text-center pt-2 pb-1'
            >
              ...
              <span className='tab tab-kategori block text-xs'>الاقسام</span>
            </Link>
            <Link
              href='#'
              className='w-full focus:text-yellow-500 hover:text-yellow-500 justify-center inline-block text-center pt-2 pb-1'
            >
              ...
              <span className='tab tab-explore block text-xs'>استكشف</span>
            </Link>
            <Link
              href='#'
              className='w-full focus:text-yellow-500 hover:text-yellow-500 justify-center inline-block text-center pt-2 pb-1'
            ...
            >
              ...
              <span className='tab tab-account block text-xs'>الحساب</span>
            </Link>
          </div>
        </section>
      </div>
